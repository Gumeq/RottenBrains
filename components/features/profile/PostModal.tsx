...
export default function PostModal({
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
			<dialog
				className="relative max-h-[70vh] w-full max-w-[95vw] overflow-hidden rounded-[16px] bg-background text-foreground shadow-lg lg:aspect-[16/9] lg:max-h-[90vh] lg:w-[60vw]"
				open={isOpen}
			>
				<button
					onClick={handleClose}
