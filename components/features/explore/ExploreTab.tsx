...
export async function ExploreTab({
  ...
  return (
    <div className="flex w-full flex-col gap-8 border-foreground/20 md:gap-16 md:rounded-[16px] md:border md:p-8">
      ...
      <div className="hidden-scrollbar flex w-full snap-x snap-mandatory grid-cols-[repeat(auto-fit,minmax(320px,1fr))] flex-row gap-4 overflow-x-auto px-4 md:grid">
        {exploreData &&
