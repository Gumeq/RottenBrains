...
export async function ExploreTab({
  ...
  return (
    <div className="flex w-full flex-col gap-8 border-foreground/20 lg:gap-8 lg:rounded-[16px] lg:border lg:p-8">
      ...
      <div className="hidden-scrollbar flex w-full snap-x snap-mandatory grid-cols-[repeat(auto-fit,minmax(320px,1fr))] flex-row gap-4 overflow-x-auto px-4 lg:grid lg:px-0">
        {exploreData &&
