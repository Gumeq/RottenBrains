		...
		<>
			{!media ? (
				<>
					...
					/>
					<div className="hidden w-full flex-row justify-between lg:flex lg:gap-2">
						<Skeleton
							width={50}
							height={20}
							baseColor="#d1d5db"
				...
				<>
					...
					>
						...
						<div className="absolute bottom-0 left-0 w-full p-1 lg:p-2">
							<div className="flex w-full flex-row justify-between lg:gap-2">
					...
					{/* <div className="px-1 flex flex-row gap-2 justify-between w-[100%] h-auto items-center">
							<p className="font-bold truncate lg:text-lg text-md">
