	...
	return (
		<div className="flex w-full flex-row gap-4 p-4">
			...
			<div className="flex w-full flex-col gap-4">
				...
				<Link
					href={post_link}
					className="flex w-full flex-col justify-between gap-2 rounded-[16px] bg-foreground/10 p-4 lg:flex-row"
				>
					<div className="flex flex-col gap-2">
						<p className="text-lg">
							{notification.media_data.title ||
					...
					<div className="aspect-[16/9] flex-shrink-0 overflow-hidden rounded-[8px] lg:max-w-[200px]">
						<ImageWithFallback
							imageUrl={imageUrl}
