...
const NotificationButton: FC<NotificationButtonProps> = ({ user_id }) => {
	...
	return (
		<DropdownMenu open={open} onOpenChange={handleOpenChange}>
			...
			<DropdownMenuContent
				className="mx-2 max-h-[70vh] max-w-[95vw] overflow-y-auto rounded-[8px] border-none bg-background p-0 drop-shadow-lg lg:mt-4 lg:max-h-[50vh] lg:w-[600px]"
				align="end"
			>
				<div className="flex h-full w-full flex-col bg-foreground/10 pb-4">
					<h2 className="w-full p-4 text-lg font-medium">
						Notifications
					</h2>
