        ...
        {!media ? (
          ...
          <>
            <Link
              ...
              className="relative rounded-[8px] border-2 border-transparent transition ease-in-out hover:z-20 hover:scale-110 hover:border-foreground hover:drop-shadow-xl"
            >
