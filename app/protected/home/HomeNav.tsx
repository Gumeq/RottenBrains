  ...
  return (
    <div>
              ...
              <div className="flex flex-row items-center">
                ...
                <Link href={"/protected/home"} className="">
                  {/* <img
									...
									/> */}
                  <h1 className="text-lg font-black">RottenBrains</h1>
                </Link>
              </div>
            </div>
      ...
      <div className="relative hidden flex-row lg:flex lg:h-svh lg:w-screen">
        {isSidebarOpen ? (
          <div className="mt-16 min-w-[240px] rounded-tr-[32px] bg-primary/10">
          ...
          <div className="mt-16 min-w-16 rounded-tr-[32px] bg-primary/10">
        ...
        <div className="custom-scrollbar mt-16 overflow-y-auto overflow-x-hidden">
          {children}
        </div>
      </div>
