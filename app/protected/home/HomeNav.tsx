...
const HomeNav = ({ children }: any) => {
	...
	return (
		<div>
			<nav
				className={`fixed top-0 bg-background/50 backdrop-blur-xl w-screen h-16 items-center justify-center z-30 hidden p-1 lg:flex`}
			>
			...
			<div className="lg:w-screen lg:h-svh lg:flex flex-row hidden">
				{isSidebarOpen ? (
					<div className="min-w-[250px] mt-16">
					...
					<div className="min-w-16 bg-background mt-16">
				...
				<div className="mt-16 overflow-y-auto overflow-x-hidden">
					{children}
				</div>
			</div>
