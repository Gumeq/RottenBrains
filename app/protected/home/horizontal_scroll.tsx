    ...
    <div className="relative w-full">
      ...
      {canScrollLeft && (
        <button
          ...
          className="absolute left-0 top-1/2 z-10 hidden -translate-y-1/2 rounded-full bg-black/40 p-2 text-white hover:bg-black/80 focus:outline-none lg:flex"
        >
          BACK
        </button>
      )}
      ...
      <div
        ref={containerRef}
        className="hidden-scrollbar flex snap-x snap-mandatory flex-row gap-4 overflow-x-auto px-4 lg:px-8 lg:pb-8 lg:pt-0"
      ...
      {canScrollRight && (
        <button
          ...
          className="absolute right-0 top-1/2 z-10 hidden -translate-y-1/2 rounded-full bg-black/40 p-2 text-white hover:bg-black/80 focus:outline-none lg:flex"
        >
          FORWARD
        </button>
      )}
